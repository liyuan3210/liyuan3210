...
| 任务名称                                                     | 备注 | 是否完成 |
| ------------------------------------------------------------ | ---- | -------- |
| 1.履历整理,找job(刷面试题),规划（自媒体规划）                |      |          |
| 2.英语(第一册)，高数（微积分），文档整理（note->devops:*vpn与镜像拉取，B站视频拉取，ipv6地址使用，k8s集群部署） |      |          |
| 3.理财（基金，股票），新媒体（运营课程），机车（买二手车）   |      |          |
| 4.java基础工程（spring boot项目），项目(电商系统，netty分布式聊天系统，涉及前端UI) |      |          |
| 5.英语(一册,二册,三册,四册)，高数(微积分，线性代数，概率论与数理统计。。。)，文档整理（note） |      |          |
